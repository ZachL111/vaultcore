...
vaultcore is a Kotlin project for security tooling. It focuses on this technical goal: Validate password vault envelope metadata and KDF policy choices.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 170, risk penalty 4, latency penalty 3, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
