"""Regression checks for the vaultcore casebook."""
...
from casebook.harness import assert_expected, vaultcore_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(vaultcore_summary(), assert_expected())
