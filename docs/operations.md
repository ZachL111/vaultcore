...
`vaultcore` is centered on security tooling work in Kotlin. The technical target is: Validate password vault envelope metadata and KDF policy choices.
...
The score is deterministic. The current threshold is 170. Risk has a penalty of 4, latency has a penalty of 3, and weight contributes a bonus of 6.
